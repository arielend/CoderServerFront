    ...
    return(
        <div className="flex flex-col items-center relative border border-csGreen rounded rounded-xl bg-white text-black w-[40rem] m-8 p-8 overflow-hidden item-shadow">
            ...
            <div className="flex w-full justify-between items-center">
                <img className="w-[18rem]" src={photo} alt={`${title} photo`}/>
                <div className="flex gap-2 flex-col content-between items-center">
                    <button>
                        <img className="h-16" src="https://firebasestorage.googleapis.com/v0/b/coderserver-1ccaf.appspot.com/o/icons%2FisFav_icon.svg?alt=media&token=69571d99-a436-43b9-b546-fa3300526a00" alt="fav icon"/>
                    </button>
                    <button>
                        <img className="h-16" src="https://firebasestorage.googleapis.com/v0/b/coderserver-1ccaf.appspot.com/o/icons%2Fshare_icon.svg?alt=media&token=f0ffe948-9ecf-4eb1-b79d-5908e38dd0ac" alt="fav icon"/>
                    </button>
                </div>
            </div>            
